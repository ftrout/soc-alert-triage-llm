...
class TestAlertCategory:
    ...
    def test_all_categories_exist(self):
        ...
        expected = [
            ...
            "insider_threat", "policy_violation", "vulnerability_exploit",
            "reconnaissance", "denial_of_service"
        ]
...
class TestTriageDecision:
    ...
    def test_requires_action(self):
        ...
        assert TriageDecision.ESCALATE.requires_action == True
        assert TriageDecision.INVESTIGATE.requires_action == True
        assert TriageDecision.MONITOR.requires_action == False
        assert TriageDecision.FALSE_POSITIVE.requires_action == False
        assert TriageDecision.CLOSE.requires_action == False
...
class TestIntegration:
    ...
    def test_full_pipeline(self):
        ...
        assert result.escalation_precision == 1.0 or result.escalation_precision == 0.0  # No escalations possible
