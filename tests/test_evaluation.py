...
class TestTriageEvaluator:
    ...
    def test_evaluate_with_categories(self, evaluator):
        ...
        for i in range(5):
            pred = {"decision": "escalate", "priority": 1, "escalation_required": True, "category": "malware"}
            gt = {"decision": "escalate", "priority": 1, "escalation_required": True, "category": "malware"}
            evaluator.add_prediction(pred, gt, "malware")
        
        for i in range(5):
            pred = {"decision": "investigate", "priority": 2, "escalation_required": False, "category": "phishing"}
            gt = {"decision": "investigate", "priority": 2, "escalation_required": False, "category": "phishing"}
    ...
    def test_priority_within_one(self, evaluator):
        ...
        ground_truth = [
            ...
            {"decision": "escalate", "priority": 1, "escalation_required": True},  # within 1: yes
            {"decision": "escalate", "priority": 2, "escalation_required": True},  # within 1: no (diff=3)
        ]
